...
const departmentsData = {
    cancerSpecialities: {
        ...
        items: [
            ...
            { title: "Preventive Oncology", link: "../Departments/Community_Oncology_Department.html" }
        ]
    },
    diagnosticsSpecialities: {
        ...
        color: "medical-green",
        items: [
            { title: "Radio diagnosis", link: "../Departments/Radio_diagnosis_Oncologic_Imaging_Department.html" },
    ...
    clinicalSpecialities: {
        ...
        items: [
            ...
            { title: "Transfusion Medicine & Blood Centre", link: "../Departments/Transfusion_Medicine_Blood_Centre.html" }
...
const navigationData = {
    ...
    cancerCare: {
        cancersWeTreat: {
            ...
            color: "medical-blue",
            items: [
                { title: "Cancer-We-Treat", link: "../cancer-we-treat/All-Types-Cancer.html" },
                {
                    ...
                    items: [
                        { title: "Breast Cancer", link: "../cancer-we-treat/Breast-Cancer.html" },
                        {
                            ...
                            link: "cancer-we-treat/Gynecologic-Cancer.html",
                            bold: true,
                            items: [
                ...
                },
                {
                    title: "Other Cancers",
                    items: [
                        { title: "Paediatric Cancer", link: "../cancer-we-treat/Paediatric-Cancer.html" },
                        { title: "Blood Cancer", link: "../cancer-we-treat/Blood-Cancer.html" },
                        { title: "Rare Cancers", link: "../cancer-we-treat/Rare-Cancers.html" }
                    ]
                }
            ]
        },
        organSpecific: {
            ...
            color: "medical-teal",
            items: [
                { title: "Head & Neck Cancer", link: "../cancer-we-treat/Head-Neck-Cancer.html" },
                ...
                { title: "Lung Cancer", link: "../cancer-we-treat/Lung-Cancer.html" },
                {
                    ...
                    bold: true,
                    items: [
                        { title: "Liver Tumours", link: "../cancer-we-treat/Liver-Tumours.html" },
                ...
                { title: "Kidney Cancers", link: "../cancer-we-treat/Urological-Cancers.html" },
